...
To specify that we want to include the change in the log serum bilirubin levels during the last year before $t$, we specify `eps = 1` and `direction = "back"` in the call to `slope()`:
```{r}
