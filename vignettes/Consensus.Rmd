---
title: "Scaling/Federating Joint Models with Consensus Monte Carlo"
...
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Scaling/Federating Joint Models with Consensus Monte Carlo}
...
# 2. Split the dataset into `n_slices` subsamples
...
# 3. Specify the number of available cores
n_cores <- max(1L, parallelly::availableCores(omit = 1L))

# 4. Fit the longitudinal and survival submodels on each subsample
## 4.1 Fit a linear mixed-effects model 
...
## 4.2 Fit a proportional-hazards model
...
# 5. Fit joint model(s) on each subsample
