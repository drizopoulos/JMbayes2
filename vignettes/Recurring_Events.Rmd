...
$$
\begin{pmatrix} \colorbox{blue}{$b_{1_i}$} \\ \vdots \\ \colorbox{red}{$b_{p_i}$} \\ \colorbox{green}{$b_{F_i}$}\end{pmatrix} \sim \mathcal{N} \left(0, \begin{pmatrix}D & 0 \\ & \sigma^2_F\end{pmatrix}\right), \qquad
